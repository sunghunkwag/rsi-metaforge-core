# Phase F Report — Acceptance Outputs

Phase F substance (attribution table, coverage audit, trigger autopsy,
task-local stagnation spec) is in `docs/ATTRIBUTION_F.md`; the committed
probe artifact is `docs/attribution_probe_phaseF.json` (SHA-256
`6909c3ea9c34ba2f7ec0b324cb7e7c99389700712e8dd89b03559bc637666a2d`,
two consecutive runs byte-identical). This file carries the full
untruncated acceptance outputs and the full probe output.
...
........................................................................ [ 51%]
....................................................................     [100%]
140 passed in 848.11s (0:14:08)
```

## Full probe output (attribution-probe, run 1 of 2; run 2 byte-identical)
...
```json
{
  ...
  "transfer_coverage": {
    "archive_elites_total": 246,
    "characterized_offered": 15,
    "characterized_total": 134,
    "mdl_positive_offered": 1,
    "mdl_positive_total": 773,
    "offer_rule": "pool[w*3:(w+1)*3] for waves 0..6 in frozen elite order",
    "offered": 21,
    "pool_total": 192
  }
}
