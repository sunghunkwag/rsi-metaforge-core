...
- Sealed task gates are created by [`_make_gate`](../rsi_levels_metaforge_unified.py#L451) and packaged by [`seal_task`](../rsi_levels_metaforge_unified.py#L466).
- The primary self-modification gate is [`meta_gate`](../rsi_levels_metaforge_unified.py#L1665), which only lands a searcher change when it creates newly gated reachable work.
- [`tcci_pre_score`](../rsi_levels_metaforge_unified.py#L1608) orders macro candidates with compression, transfer, and anti-cheat components, but recovery through holdout and counterfactual gates remains the hard acceptance condition.
- [`run_wave`](../rsi_levels_metaforge_unified.py#L2055) rechecks training outputs, then applies holdout and counterfactual gates before recording task adoption.
- [`forge_admit`](../rsi_levels_metaforge_unified.py#L8169), [`gd_validates`](../rsi_levels_metaforge_unified.py#L37559), and [`structural_gate`](../rsi_levels_metaforge_unified.py#L7033) cover additional local gate types.
...
- [`test_synthesizer_receives_no_oracle`](../rsi_levels_metaforge_unified.py#L2704)
- [`test_no_task_to_solution_lookup`](../rsi_levels_metaforge_unified.py#L2755)
- [`test_no_dynamic_python_evaluator_calls`](../rsi_levels_metaforge_unified.py#L2877)
- [`test_fw_hidden_expectations_never_on_disk`](../rsi_levels_metaforge_unified.py#L9614)
- [`test_fw_agents_never_touch_sealed_scoring`](../rsi_levels_metaforge_unified.py#L9632)
- [`test_speculative_adoption_gate_fenced_and_rolls_back`](../rsi_levels_metaforge_unified.py#L14057)
- [`test_grammar_gate_not_weakened_honest_giveup`](../rsi_levels_metaforge_unified.py#L14412)
- [`test_grammar2_gate_not_weakened_honest_giveup`](../rsi_levels_metaforge_unified.py#L14750)
