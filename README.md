...
# Run the full test suite (178 tests)
...
- **Full Evidence** — runs every evidence battery (including the self-curriculum battery twice, asserting byte-identical digests) plus the full 178-test suite, then uploads the logs and JSON artifacts. Green means the whole record reproduced on a clean machine.
